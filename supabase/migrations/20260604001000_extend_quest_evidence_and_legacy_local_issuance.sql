-- Add typed quest evidence columns used by the authority RPCs and evidence
-- claim functions.
...
-- If the local-niche schema was applied manually before migrations existed,
-- this can repair legacy server-generated local quests immediately. The
-- ordered migration stack also repeats this after local_niches.sql is applied.
do $$
begin
  if exists (
    select 1
